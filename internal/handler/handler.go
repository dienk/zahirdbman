...
func (h *Handler) Routes() *http.ServeMux {
	...
	mux.HandleFunc("/api/table", h.apiTable)
	mux.HandleFunc("/api/databases/create", h.apiCreateDatabase)
	mux.HandleFunc("/api/databases/drop", h.apiDropDatabase)
	mux.HandleFunc("/api/restore", h.apiRestore)
